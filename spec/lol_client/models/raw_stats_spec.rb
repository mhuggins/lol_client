...
describe LolClient::RawStats do
  subject { described_class.new(attributes) }

  let(:attributes) { attributes_for :raw_stats }

  [:assists, :barracks_killed, :champions_killed, :combat_player_score, :consumables_purchased,
   ...
   :neutral_minions_killed_enemy_jungle, :neutral_minions_killed_your_jungle, :nexus_killed,
   ...
   :unreal_kills, :victory_point_total, :vision_wards_bought, :ward_killed, :ward_placed, :win].each do |attr|
